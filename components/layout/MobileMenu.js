            ...
            <ul className="main-menu__list">
              ...
              >
                ...
                >
                  ...
                  <li
                    className={
                      isActive.subMenuKey == 2 ? "dropdown current" : "dropdown"
                    }
                  >
                    <Link href="#" onClick={handleMobileMenu}>
                      Header Styles
                  ...
                  <li
                    className={
                      isActive.subMenuKey == 3 ? "dropdown current" : "dropdown"
                    }
                  >
                    <Link href="#" onClick={handleMobileMenu}>
                      One Page Styles
